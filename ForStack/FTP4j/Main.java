...
public class Main extends Application{
    ...
    private void FTPGet(String genomeName, String genomeStrain, String genomeLink) throws IllegalStateException, IOException, FTPIllegalReplyException, FTPException, FTPDataTransferException, FTPAbortedException, FTPListParseException {
        gcf = true;
        ...
        client.setAutoNoopTimeout(300 * 60000);
        ...
        if (genomeName.contains(StrainSplitted[1]))
        {
            ...
            bar.setProgress(0.4);
            ind.setProgress(0.4);
            client.download(genomeCode + "_genomic.fna.gz", new java.io.File(dir + "\\" + genomeName + "\\" + "GenomicFNA.gz"));
            bar.setProgress(0.6);
            ind.setProgress(0.6);
            client.download(genomeCode + "_genomic.gbff.gz", new java.io.File(dir + "\\" + genomeName + "\\" + "GenomicGBFF.gz"));
            bar.setProgress(0.8);
            ind.setProgress(0.8);
        } else {
            client.download(genomeCode + "_assembly_report.txt", new java.io.File(dir + "\\" + genomeName + " " + StrainSplitted[1] + "\\" + "Assembly Report.txt"));
            bar.setProgress(0.2);
            ind.setProgress(0.2);
            client.download(genomeCode + "_assembly_stats.txt", new java.io.File(dir + "\\" + genomeName + " " + StrainSplitted[1] + "\\" + "Assembly Stats.txt"));
            bar.setProgress(0.4);
            ind.setProgress(0.4);
            client.download(genomeCode + "_genomic.fna.gz", new java.io.File(dir + "\\" + genomeName + " " + StrainSplitted[1] + "\\" + "GenomicFNA.gz"));
            bar.setProgress(0.6);
            ind.setProgress(0.6);
            client.download(genomeCode + "_genomic.gbff.gz", new java.io.File(dir + "\\" + genomeName + " " + StrainSplitted[1] + "\\" + "GenomicGBFF.gz"));
            bar.setProgress(0.8);
            ind.setProgress(0.8);
        }
        try
        {
            if (genomeName.contains(StrainSplitted[1]))
            {
                client.download(genomeCode + "_protein.faa.gz", new java.io.File(dir + "\\" + genomeName + "\\" + "ProteinFAA.gz"));
            } else {
                client.download(genomeCode + "_protein.faa.gz", new java.io.File(dir + "\\" + genomeName + " " + StrainSplitted[1] + "\\" + "ProteinFAA.gz"));
            }
